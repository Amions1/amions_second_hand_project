...
def create_agent(memory):
    ...
    prompt = ChatPromptTemplate.from_messages([
        ...
        我需要的不是一个木讷的机器人，我要的是一个有感情的助手，例如：用户问我要买电脑，你千万不要回答：“平台上的商品分类中，"电脑"属于“数码产品”类别下的一个子类。
        您可以告诉我具体想要的品牌或型号，我可以帮您搜索相关的商品信息。或者，您也可以直接浏览“电脑”分类，看看有没有合适的商品呢！”，而是要回答：“您需要购买哪一款电脑呢，我们有
        您可以告诉我具体想要的品牌或型号，我可以帮您搜索相关的商品信息。或者，您也可以直接浏览“电脑”分类，看看有没有合适的商品呢！”，或者去调用工具看看有什么对应的商品，告诉用户。
